...
def CapsNet_nogradientstop(input_shape, n_class,
    ...
    conv2 = layers.Conv1D(filters=200, kernel_size=3, strides=1, padding='valid', kernel_initializer='he_normal',
                          activation='relu', name='conv2')(conv1)  # kernel_size was previously 9
    # conv1=BatchNormalization()(conv1)
    conv2 = Dropout(0.75)(conv2)  # 0.75 valx loss has 0.1278!
    primarycaps = PrimaryCap(conv2, dim_capsule=8, n_channels=60, kernel_size=5, kernel_initializer='he_normal',
                             strides=1, padding='valid', dropout=0.2)  # kernel_size was previously 20
    dim_capsule_dim2 = 10
...
def CapsNet_nogradientstop_crossentropy(input_shape, n_class,
    ...
    conv2 = Dropout(0.75)(conv2)  # 0.75 valx loss has 0.1278!
    primarycaps = PrimaryCap(conv2, dim_capsule=8, n_channels=60, kernel_size=5, kernel_initializer='he_normal',
                             strides=1, padding='valid', dropout=0.2)  # kernel_size was previously 9
    dim_capsule_dim2 = 10
    # Capsule layer. Routing algorithm works here.
    digitcaps_c = CapsuleLayer_nogradient_stop(num_capsule=n_class, dim_capsule=dim_capsule_dim2, num_routing=routings,
                                               name='digitcaps', kernel_initializer='he_normal', dropout=0.1)(
