...
def main():
    ...
    parser.add_argument('-input',  dest='inputfile', type=str, help='training data in fasta format. Sites followed by "#" are positive sites for Zinc site prediction.', required=True)
    ...
    parser.add_argument('-window',  dest='window', type=int, help='window size: the number of amino acid of the left part or right part adjacent to a potential binding site. 2*\'windo size\'+1 amino acid will be extracted for one protential fragment \ amino acid will be extracted for one protential fragment. [Default:12]', required=False, default=12)
